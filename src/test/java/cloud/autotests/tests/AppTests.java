...
public class AppTests extends TestBase {
    ...
    @DisplayName("привет")
    void generatedTest() {
        step("открыть 'https://autotests.cloud'", () -> {
            // todo just add selenium action
        });

        step("ввести название теста 'тестовый тест'", () -> {
            // todo just add selenium action
        });

        step("ввести шаги теста 'открыть \'https://autotests.cloud\''", () -> {
            // todo just add selenium action
        });

        step("нажать кнопку 'Автоматизировать!'", () -> {
            // todo just add selenium action
        });
    }
